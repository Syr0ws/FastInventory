...
public class SimpleInventoryViewManager implements InventoryViewManager {
    ...
    @Override
    public void openView(CraftVentory inventory) {
        this.openView(inventory, true);
    }

    @Override
    public void openView(CraftVentory inventory, boolean newHistory) {
    ...
    public void backward() {
        ...
        if(this.hasBackward()) {
            ...
            CraftVentory inventory = this.history.get(--this.index);
            inventory.open();
        }
    }
    ...
    public void backward(String inventoryId) {
        ...
        for(int i = 0; i < this.index; i++) {
            ...
            CraftVentory inventory = this.history.get(i);
