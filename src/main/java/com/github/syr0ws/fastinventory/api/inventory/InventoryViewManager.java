...
public interface InventoryViewManager {
    ...
    /**
     * Opens the specified {@link FastInventory} for the viewer.
     * <p>
     * This is the same as {@code InventoryViewManager#openView(inventory, false)}
     * </p>
     *
     * @param inventory The {@link FastInventory} to open. Must not be {@code null}.
    ...
    /**
     * Retrieves the currently opened {@link FastInventory}, if any.
     *
     * @return An {@link Optional} containing the currently opened {@link FastInventory},
